...
test_cases = ['CAND_0097176', 'CAND_0058688', 'CAND_0077296']

for cid in test_cases:
    c = cand_map[cid]
    score = domain_fit_score(c)
    title = c['profile']['current_title']
    print(f"{cid} — {title}: domain_fit = {score}")

c = cand_map['CAND_0058688']
skills = c.get('skills', [])
expert_skills = [s['name'].lower() for s in skills
                 if s.get('proficiency') in ('expert','advanced')]

print("Expert skills:", expert_skills)
...
print(f"cv_hits: {cv_hits}")
print(f"ir_hits: {ir_hits}")
print(f"condition fires: {cv_hits >= 1 and ir_hits <= cv_hits}")

print('Extracting career features...')
